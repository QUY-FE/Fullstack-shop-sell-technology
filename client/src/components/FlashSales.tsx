      ...
      <div className="w-full min-h-[400px] my-10">
        {timeLeft ? (
          ...
          <div className="w-full h-[400px] px-28 ">
            <h1 className="text-8xl text-primary font-semibold leading-[120px] ">{":("}</h1>
            <p className="text-black/70 py-4 font-semibold">Hết Flash sale mất rồi, Hẹn gặp bạn ở dịp khác.</p>
          </div>
        )}
      </div>
    </section>
